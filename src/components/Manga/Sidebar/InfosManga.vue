<template>
    <div class="data">
        ...
        <div class="data-set" v-if="mangaInfo.status">
            ...
            <div class="value">{{ mangaInfo.status | capitalize }}</div>
        </div>
        ...
        <div class="data-set" v-if="mangaInfo.source">
            ...
            <div class="value">{{ mangaInfo.source | capitalize }}</div>
        </div>
...
<style scoped src="./../../../assets/css/manga/sidebar.css"></style>
