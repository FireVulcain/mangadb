      ...
      <div class="grid-wrap">
        ...
        >
          ...
          <div class="content">
            ...
            >{{ relation.node.type.toLowerCase() | capitalize }} · {{ relation.node.status.toLowerCase() | capitalize }}</div>
            <div class="info" v-else>{{ relation.node.type.toLowerCase() | capitalize }}</div>
          </div>
        </div>
      </div>
    </div>
